...
\hline
\end{DoxyParams}
Crea un árbol duplicado exacto de a. \hypertarget{classbintree_a7f32fcbdc9aed453025a13cbe93e3b89}{\index{bintree@{bintree}!$\sim$bintree@{$\sim$bintree}}
\index{$\sim$bintree@{$\sim$bintree}!bintree@{bintree}}
...
\hline
\end{DoxyParams}
Desconecta y destruye el subárbol a la derecha de n, inserta un nuevo nodo con etiqueta e como hijo a la derecha \hypertarget{classbintree_a17611b995af1d5421197d155e75e683f}{\index{bintree@{bintree}!insert\-\_\-left@{insert\-\_\-left}}
\index{insert\-\_\-left@{insert\-\_\-left}!bintree@{bintree}}
\subsubsection[{insert\-\_\-left}]{\setlength{\rightskip}{0pt plus 5cm}template$<$typename T$>$ void {\bf bintree}$<$ T $>$\-::insert\-\_\-left (
\begin{DoxyParamCaption}
\item[{{\bf node}}]{n, }
...
\hline
\end{DoxyParams}
Desconecta y destruye el subárbol a la derecha de n, le asigna el valor de rama como nuevo subárbol a la derecha y rama se hace árbol nulo. \hypertarget{classbintree_a80e397f887ebad1ef974ec7722430a6c}{\index{bintree@{bintree}!operator!=@{operator!=}}
